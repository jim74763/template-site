  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <section className="text-center mb-12">
        ...
        Main page <Link href='https://jimvanduijsen.com?utm_source=template.jimvd.xyz&utm_medium=referral&utm_campaign=template_to_main'  target="_blank" rel="noopener noreferrer" className="text-primary hover:underline inline-flex items-center gap-1">
          ...
          Built with <Link href="https://jimvd.xyz/software?utm_source=template_jimvd_xyz&utm_medium=referral&utm_campaign=template_to_main"  target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">modern technologies</Link> for optimal performance.
